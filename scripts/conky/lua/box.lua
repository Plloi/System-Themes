...
function conky_main_box()
    ...
    local bg = 5
    local sweptheight = 2
    local cpumeter = tonumber(conky_parse("${cpu cpu0}"))
    local memmeter = tonumber(conky_parse("${memperc}"))

    local colors = {
        primary = { {0,0x00FF00,1} },
        secondary = { {0,0x00AA00,1} },
        background = { {0,0x000000,1} },
    }
	---------------------- PARAMETERS BEGIN HERE
    local boxes_settings={
    --FIRST COLUMN

        {x=0, y=0,h=(bh*sweptheight)+(bg*(sweptheight-1)), colour=colors.primary, corners={{ "curve",0},{ "curve",0},{ "curve",0},{ "circle",90}}},
        {x=bw, y=0,h=(bh*sweptheight)+(bg*(sweptheight-1))-(bh/2), colour=colors.background, corners={{ "curve",0},{ "curve",0},{ "curve",0},{ "circle",45}}},

        {x=0, y=(bh*sweptheight)+(bg*(sweptheight-1))+bg,h=(bh*sweptheight)+(bg*(sweptheight-1)), colour=colors.primary, corners={{ "circle",90},{ "curve",0},{ "curve",0},{ "curve",0}}},
        {x=bw, y=(bh*sweptheight)+(bg*(sweptheight-1))+bg+(bh/2),h=(bh*sweptheight)+(bg*(sweptheight-1))-(bh/2), colour=colors.background, corners={{ "circle",45},{ "curve",0},{ "curve",0},{ "curve",0}}},

        --cpu meter
        {x=bw*2, y=(bh*sweptheight)+(bg*(sweptheight-1))+bg, w=(conky_window.width-bw*3)*(cpumeter/100), h= bh/2, colour=colors.secondary},
        {x=bw*2-bg, y=(bh*sweptheight)+(bg*(sweptheight-1))+bg, w=bg, h= bh/2, colour=colors.background},
        {x=bw*2+conky_window.width-bw*3, y=(bh*sweptheight)+(bg*(sweptheight-1))+bg, w=bg, h= bh/2, colour=colors.background},

        --mem meter
        {x=bw*2, y=(bh*sweptheight)+(bg*(sweptheight-1))-bh/2, w=(conky_window.width-bw*3)*(memmeter/100), h= bh/2, colour=colors.secondary},
        {x=bw*2-bg, y=(bh*sweptheight)+(bg*(sweptheight-1))-bh/2, w=bg, h= bh/2, colour=colors.background},
        {x=bw*2+conky_window.width-bw*3, y=(bh*sweptheight)+(bg*(sweptheight-1))-bh/2, w=bg, h= bh/2, colour=colors.background},

        {x=0, y=(bh*sweptheight*2)+(bg*(sweptheight*2-1)), w=bw, h=750, colour=colors.primary},

        {x=0, y=1075-(bh*sweptheight)+(bg*(sweptheight-1)),h=(bh*sweptheight)+(bg*(sweptheight-1)), colour=colors.primary, corners={{ "curve",0},{ "curve",0},{ "curve",0},{ "circle",90}}},
        {x=bw, y=1075-(bh*sweptheight)+(bg*(sweptheight-1)),h=(bh*sweptheight)+(bg*(sweptheight-1))-(bh/2), colour=colors.background, corners={{ "curve",0},{ "curve",0},{ "curve",0},{ "circle",45}}},
    }
